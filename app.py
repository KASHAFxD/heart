...
def indexx():
    if request.method == 'POST':
        ...
        if prediction[0] == 1:
            probability = math.floor(prediction_proba[0][1] * 100)  # Probability of heart disease
            result = 'At risk of heart disease'
        else:
            probability = math.floor(prediction_proba[0][0] * 100)  # Probability of no heart disease
